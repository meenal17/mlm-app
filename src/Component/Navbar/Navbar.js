				...
				<div  className="container-fluid">
					<div  className="main-header-left ">
						<div  className="app-sidebar__toggle mobile-toggle" data-toggle="sidebar">
							<a  className="open-toggle" href="#"><i  className="header-icons" data-eva="menu-outline"></i></a>
							<a  className="close-toggle" href="#"><i  className="header-icons" data-eva="close-outline"></i></a>
						</div>
					...
					<div  className="main-header-right">
						<div  className="nav nav-item  navbar-nav-right ml-auto">
							<form  className="navbar-form nav-item my-auto d-lg-none" role="search">
							...
							<div  className="nav-item full-screen fullscreen-button">
								<a  className="new nav-link full-screen-link" href="#"><i  className="ti-fullscreen"></i></span></a>
							</div>
							<div  className="dropdown  nav-item main-header-message ">
								<a  className="new nav-link" href="#" ><i  className="ti-email"></i><span  className="pulse-danger"></span></a>
								<div  className="dropdown-menu dropdown-menu-arrow animated fadeInUp ">
									<div  className="main-dropdown-header  d-sm-none">
										<a  className="main-header-arrow" href=""><i  className="icon ion-md-arrow-back"></i></a>
									</div>
							...
							<div  className="dropdown nav-item main-header-notification">
								<a  className="new nav-link " href="#"><i  className="ti-bell animated bell-animations"></i><span  className=" pulse"></span></a>
								<div  className="dropdown-menu dropdown-menu-arrow animated fadeInUp">
									<div  className="menu-header-content text-left d-flex">
										<div  className="">
							...
							<button  className="navbar-toggler navresponsive-toggler d-sm-none" type="button" data-toggle="collapse" data-target="#navbarSupportedContent-4"
								aria-controls="navbarSupportedContent-4" aria-expanded="false" aria-label="Toggle navigation">
								<span  className="navbar-toggler-icon fe fe-more-vertical "></span>
							</button>
							<div  className="dropdown main-profile-menu nav nav-item nav-link">
								<a  className="profile-user" href=""><img alt="" src="../../assets/img/faces/5.jpg"></a>
								<div  className="dropdown-menu dropdown-menu-arrow animated fadeInUp">
									<div  className="main-header-profile header-img">
										<div  className="main-img-user"><img alt="" src="../../assets/img/faces/5.jpg"></div>
										<h6>Elizabeth Jane</h6><span>Premium Member</span>
									</div>
									<a  className="dropdown-item" href=""><i  className="far fa-user"></i> My Profile</a>
									<a  className="dropdown-item" href=""><i  className="far fa-edit"></i> Edit Profile</a>
									<a  className="dropdown-item" href=""><i  className="far fa-clock"></i> Activity Logs</a>
									<a  className="dropdown-item" href=""><i  className="fas fa-sliders-h"></i> Account Settings</a>
									<a  className="dropdown-item" href="page-signin.html"><i  className="fas fa-sign-out-alt"></i> Sign Out</a>
								</div>
							</div>
							<div  className="dropdown main-header-message right-toggle">
								<a  className="nav-link " data-toggle="sidebar-right" data-target=".sidebar-right">
